# Pokémon Tool Kit - Development Session Protocols

## Overview
This document defines the mandatory session protocols for all Claude Code development sessions on the Pokémon Tool Kit project. These protocols ensure continuity, quality, and proper documentation across sessions.
...
- [ ] Verify working directory: `/mnt/c/Users/haith/Documents/Vibe Projects/Poke-Kit`
- [ ] Check which project (web-app vs android-app) is the focus
- [ ] Verify Node.js/npm installed (for web-app)
- [ ] Verify Android Studio/Kotlin setup (for android-app when needed)

### 3. Current State Assessment
- [ ] Run `git status` to see uncommitted changes
- [ ] Check if dev server is running (web-app)
...
**File naming format:** `handoff/MM-DD-YYYY_HH-MM-SS_EDT.md`
...
```markdown
**Handoff MM-DD-YYYY_HH-MM-SS_EDT** - [Brief 1-sentence summary of session], build status: [working/broken], user confirmed: [yes/no]
```
...
```markdown
# Session Handoff - [MM/DD/YYYY HH:MM:SS EDT]
...
**Build/Dev Server:**
- [Status of `npm run dev`, any errors encountered]
...
- [ ] Responsive design tested (mobile + desktop for web-app)
...
User: "Let's build the type calculator"
...
2. Creating handoff/11-13-2025_20-30-45_EST.md...
